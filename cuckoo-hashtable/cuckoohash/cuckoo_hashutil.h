 ...
 */
#ifdef __GNUC__
#define CUCKOOHASH_ALIGNAS(x) __attribute__((aligned(x)))
#else
#define CUCKOOHASH_ALIGNAS(x) alignas(x)
#endif
 ...
 */
#ifdef _MSC_VER
#define CUCKOOHASH_SQUELCH_PADDING_WARNING __pragma(warning(suppress : 4324))
#else
#define CUCKOOHASH_SQUELCH_PADDING_WARNING
#endif
