...
namespace cuckoohash
{
    ...
    public:
         ...
         */
        template <typename K>
        bool find(const K &key, key_type &keyval) const
        {
    ...
    private:
        ...
        cuckoo_status cuckoo_expand_simple(size_type new_hp)
        {
            ...
            parallel_exec(
                0, hashsize(hp),
                [this, &new_table](size_type i, size_type end, std::exception_ptr &eptr) {
                    try
                    {
                        for (; i < end; ++i)
                        {
        ...
        */
        ...
        public:
            ...
            */
            ...
            template <typename K>
            const key_type &at(const K &key) const
            {
                auto it = find(key);
                if (it == end())
                {
